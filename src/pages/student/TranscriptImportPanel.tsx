...
export default function TranscriptImportPanel({ admissionYear }: { admissionYear: number }) {
  ...
  return (
    <details className="transcript-import-panel">
      ...
      {importer.data && <p className="import-success">가져오기 #{importer.data.importId}: 학생 {importer.data.createdStudents}명 생성, 지원정보 {importer.data.createdApplications}건 생성, 과목 {importer.data.createdCourses}건 생성·{importer.data.updatedCourses}건 수정</p>}
